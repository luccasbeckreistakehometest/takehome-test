  ...
  content: {
    pt: {
      ...
      benefits: [
        ...
        { icon: "users", t: "Teste o post antes de publicar", d: "Uma simulação com as personas da sua estratégia compara versões do texto e aponta a mais forte." },
    ...
    en: {
      ...
      benefits: [
        ...
        { icon: "users", t: "Test the post before publishing", d: "A simulation with your strategy's personas compares versions of the copy and points out the strongest." },
