  ...
  content: {
    pt: {
      ...
      faq: [
        ...
        { q: "Como uma agência entra?", a: "Por convite, enquanto preparamos espaços separados por agência. Peça acesso e respondemos por e-mail." },
      ],
    ...
    en: {
      ...
      faq: [
        ...
        { q: "How does an agency join?", a: "By invitation while we prepare separate spaces per agency. Request access and we reply by email." },
      ],
