...
export function LangToggle() {
  return (
    <button
      ...
      className="rounded-md border border-edge bg-surface-sunken px-2 py-1 t5 font-semibold text-text-muted transition-colors hover:border-edge hover:text-text"
